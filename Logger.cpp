...
static const QString defaultLogName = "oscillate-wallet-gui.log";
#if defined(Q_OS_IOS)
    ...
    static const QString appFolder = "oscillate-wallet-gui";
    ...
    //HomeLocation = "~"
    static const QString osPath = QStandardPaths::standardLocations(QStandardPaths::HomeLocation).at(0);
    static const QString appFolder = ".oscillate";
#endif
